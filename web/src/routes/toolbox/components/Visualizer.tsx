...
const VISUALIZER_INFO = {
  profile: {
    ...
    description: 'Visualize kiln firing profiles - see temperature trajectory over time',
    icon: LineChart,
  },
  run: {
    title: 'Run Visualizer',
    description: 'Visualize kiln firing or tuning runs - see temperature, SSR output, and rate data',
    icon: Activity,
  },
  tuning: {
...
export function Visualizer() {
  const [visualizerType, setVisualizerType] = useState<VisualizerType>('profile');
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            <div>
              <label className="text-sm font-medium">Select Visualization Type</label>
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs opacity-80">Temperature trajectory</div>
                </div>
              </Button>
              <Button
