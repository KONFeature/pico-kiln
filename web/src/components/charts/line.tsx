...
export interface LineProps {
	...
	dataKey: string;
	/**
	 * Optional per-series data override. When provided, this line renders from
	 * its own (contiguous) slice instead of the chart's shared `renderData` —
	 * used to draw multi-colored profile segments on one shared time/value axis.
	 */
...
export function Line({
	...
	const seriesData = dataProp ?? renderData;
