...
pub struct KilnConfig {
    ...
    pub stall_saturation_output: f64,
    pub stall_saturation_window: f64,
...
impl KilnConfig {
    ...
    pub fn controller_config(&self) -> ControllerConfig {
        ControllerConfig {
            ...
            stall_saturation_output: self.stall_saturation_output as f32,
            stall_saturation_window: self.stall_saturation_window as f32,
        }
    }
    ...
    pub fn write_json<W: Write>(&self, w: &mut W) -> fmt::Result {
        ...
        j.float("STALL_SATURATION_OUTPUT", self.stall_saturation_output)?;
        j.float("STALL_SATURATION_WINDOW", self.stall_saturation_window)?;
...
fn apply_key(cfg: &mut KilnConfig, key: &str, r: &mut Reader) -> Result<(), ConfigError> {
    match key {
        ...
        "STALL_SATURATION_OUTPUT" => cfg.stall_saturation_output = r.parse_number()?,
        "STALL_SATURATION_WINDOW" => cfg.stall_saturation_window = r.parse_number()?,
